...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Dec 05, 2021 at 11:40 PM
...
(1, 'anuj161996@gmail.com', 'Anuj', 'Narang', 'Mount', '25', 'Male', '1996-09-16', '\r\n                    Hey There', 'Admin@123'),
...
(5, 'Cobbie@gmail.com', 'Lisbon', 'Yes', 'Montreal', '30', 'Female', '1990-06-16', 'Hey', 'Admin@123'),
...
INSERT INTO `message` (`MessageID`, `SenderID`, `ReciverID`, `MESSAGE`, `Time`, `ReadMessage`) VALUES
(1, 1, 5, '                     Hii\r\n', 'Thu Dec 2 22:31:22 CET 2021', 0),
(2, 1, 5, '                     You there', 'Thu Dec 2 22:31:27 CET 2021', 0);

-- --------------------------------------------------------

--
-- Table structure for table `winkbox`
--

DROP TABLE IF EXISTS `winkbox`;
CREATE TABLE `winkbox` (
  `WinkboxID` int(11) NOT NULL,
  `CustomerID` int(11) DEFAULT NULL,
  `ParnerId` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `winkbox`
--

INSERT INTO `winkbox` (`WinkboxID`, `CustomerID`, `ParnerId`) VALUES
(1, 1, 4),
(2, 1, 4),
(3, 1, 5),
(4, 1, 2),
...
--
-- Indexes for table `winkbox`
--
ALTER TABLE `winkbox`
  ADD PRIMARY KEY (`WinkboxID`),
  ADD KEY `CustomerID` (`CustomerID`),
  ADD KEY `ParnerId` (`ParnerId`);
...
--
-- AUTO_INCREMENT for table `winkbox`
--
ALTER TABLE `winkbox`
  MODIFY `WinkboxID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- Constraints for table `winkbox`
--
ALTER TABLE `winkbox`
  ADD CONSTRAINT `wink_ibfk_1` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`CustomerID`),
  ADD CONSTRAINT `wink_ibfk_2` FOREIGN KEY (`ParnerId`) REFERENCES `customer` (`CustomerID`);
COMMIT;
