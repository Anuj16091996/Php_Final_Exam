...
<div class="container">
    ...
    <div class="services">
        <div class="col-sm-6 login_left">
            ...
            <form action="../Controller/ModifyValidation.php" method="post" enctype="multipart/form-data">


                <div class="form-group">
                    <label for="edit-pass">Age <span class="form-required"
                                                     title="This field is required.">*</span></label>
                    <input type="number" value="25" required id="edit-pass" name="age" size="60" maxlength="128"
                           class="form-text required">
                </div>
                <div class="form-group">
                    <label for="edit-pass">FirstName <span class="form-required"
                                                           title="This field is required.">*</span></label>
                    <input type="text" required value="qwe" id="edit-pass" name="fname" size="60" maxlength="128"
                           class="form-text required">
                </div>

                <div class="form-group">
                    <label for="edit-pass">LastName <span class="form-required" title="This field is required.">*</span></label>
                    <input type="text" value="qwe" required id="edit-pass" name="lname" size="60" maxlength="128"
                           class="form-text required">
                </div>

                <div class="form-group">
                    <label for="edit-pass">City <span class="form-required"
                                                      title="This field is required.">*</span></label>
                    <input type="text" required value="qwe" id="edit-pass" name="city" size="60" maxlength="128"
                           class="form-text required">
                </div>
                ...
                <div class="form-group">
                    <label for="edit-pass">DateOfBirth: <span class="form-required"
                                                              title="This field is required.">*</span></label>
                    <input type="date" required id="edit-pass" value="1996-09-16" name="dob" size="60" maxlength="128"
                           class="form-text required">
                </div>
