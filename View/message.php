...
$PartnerMessage = MessageDataBase::ReadMessage($PartnerID, $UserID);
...
<div class="container">
    <div class="breadcrumb1">
        <ul>
            ...
            ->&nbsp;<a href="PartnerProfile.php?id=<?= $PartnerID ?>"><?= $PartnerFullName ?></i></a>
            ->
...
<div class="container">
    ...
    <table class="table" border="">
        <tr>
            <td align="center" class="tableHead" colspan="2">Chat With <?php echo "$PartnerFullName" ?></td>
        </tr>
        <tr>
            <td colspan="2">
                <div class="container">
                    <div class="fields" style="overflow:scroll;height:550px">
                        <?php
                        foreach ($UserMessage as $number => $array) {
                            ...
                            if ($array["SenderID"] == $UserID) {
                                ...
                                if ($array["ReadMessage"] == 1) {
                                    echo "<p style='color:black;text-align: right;padding-right: 30px;border:0px solid #000;padding: 1px'> Read </p>";
                                }
                            } else {
...
<tr>
    <td>
                    <textarea name="msg" class="fields" placeholder="Enter Your Message" required="required"
                              style="background-color: #c9c9c9;width: 100%">
                     </textarea>
    </td>
    <td>
